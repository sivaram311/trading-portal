...
try {
    Write-Host "Running: python -m trading_portal_ingest $Mode $ExtraArgs (env=preprod, schema=preprod)" -ForegroundColor Green
    if ($ExtraArgs) {
